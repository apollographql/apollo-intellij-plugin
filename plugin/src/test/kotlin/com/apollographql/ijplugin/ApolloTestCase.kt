...
@TestDataPath("\$CONTENT_ROOT/../../../test-project")
abstract class ApolloTestCase : LightJavaCodeInsightFixtureTestCase() {
  open val mavenLibraries: List<String> =
    listOf("apollo-annotations", "apollo-api", "apollo-runtime", "org.jetbrains.kotlin:kotlin-stdlib:2.0.0")
    ...
    override fun configureModule(module: Module, model: ModifiableRootModel, contentEntry: ContentEntry) {
      for (library in mavenLibraries) {
        if (library.contains(":")) {
          ...
          val jarPath = "build/apolloDependencies/$library-jvm-$APOLLO_VERSION.jar"
  ...
  override fun getTestDataPath() = "../test-project"
