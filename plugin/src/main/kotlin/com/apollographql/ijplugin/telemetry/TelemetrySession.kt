...
sealed class TelemetryProperty(
   ...
   */
  class ApolloWarnOnDeprecatedUsages(warnOnDeprecatedUsages: Boolean) :
    TelemetryProperty("ak_warn_on_deprecated_usages", warnOnDeprecatedUsages)
   ...
   */
  class ApolloGenerateFragmentImplementations(generateFragmentImplementations: Boolean) :
    TelemetryProperty("ak_generate_fragment_implementations", generateFragmentImplementations)
   ...
   */
  class ApolloGenerateOptionalOperationVariables(generateOptionalOperationVariables: Boolean) :
    TelemetryProperty("ak_generate_optional_operation_variables", generateOptionalOperationVariables)
   ...
   */
  class ApolloGeneratePrimitiveTypes(generatePrimitiveTypes: Boolean) :
    TelemetryProperty("ak_generate_primitive_types", generatePrimitiveTypes)
   ...
   */
  class ApolloFieldsOnDisjointTypesMustMerge(fieldsOnDisjointTypesMustMerge: Boolean) :
    TelemetryProperty("ak_fields_on_disjoint_types_must_merge", fieldsOnDisjointTypesMustMerge)

  /**
   * Value of the Apollo Kotlin option `generateApolloMetadata` if set.
   */
  class ApolloGenerateApolloMetadata(generateApolloMetadata: Boolean) :
    TelemetryProperty("ak_generate_apollo_metadata", generateApolloMetadata)
   ...
   */
  class ApolloGenerateSourcesDuringGradleSync(generateSourcesDuringGradleSync: Boolean) :
    TelemetryProperty("ak_generate_sources_during_gradle_sync", generateSourcesDuringGradleSync)
