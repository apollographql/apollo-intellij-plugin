...
class ApolloUnusedFieldInspection : LocalInspectionTool() {
  ...
  override fun createOptionsPanel(): JComponent {
    val form =
      ListEditForm(ApolloBundle.message("inspection.unusedField.options.fieldsToIgnore.title"), ApolloBundle.message("inspection.unusedField.options.fieldsToIgnore.label"), fieldsToIgnore)
