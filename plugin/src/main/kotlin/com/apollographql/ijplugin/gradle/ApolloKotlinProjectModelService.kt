...
class ApolloKotlinProjectModelService(
  ...
  /**
   * Fetch the Apollo Kotlin project model, either by fetching the JSON IDE models generated by the Apollo Gradle plugin
   * (`generateApolloProjectIdeModel` task introduced in v5) or by fetching the Gradle tooling models (legacy).
   *
  ...
  private inner class FetchProjectModelTask : Runnable {
    ...
    /**
     * Fetch the project model via JSON files generated by the Apollo Gradle plugin (the `generateApolloProjectIdeModel` task).
    ...
    /**
     * Fetch the project model via Gradle tooling models exposed bu the Apollo Gradle plugin.
  ...
  /**
   * Compute the ApolloKotlinServices from IDE models, taking into account the dependencies between projects.
   */
