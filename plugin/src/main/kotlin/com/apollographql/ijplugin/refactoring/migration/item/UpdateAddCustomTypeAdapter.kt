...
object UpdateAddCustomTypeAdapter : MigrationItem() {
  ...
  override fun performRefactoring(project: Project, migration: PsiMigration, usage: MigrationItemUsageInfo): PsiElement? {
    ...
    val firstArgument = callExpression.valueArguments.firstOrNull() ?: return null
    val argumentDotQualifiedExpression = firstArgument.getArgumentExpression() as? KtDotQualifiedExpression ?: return null
    // e.g. `DATETIME`
    val typeReference = argumentDotQualifiedExpression.selectorExpression as? KtNameReferenceExpression ?: return null
    val enumEntry = typeReference.resolve() as? KtEnumEntry ?: return null
    val classBody = enumEntry.body ?: return null
    // 1st function looks like `override fun typeName(): String = "DateTime"`
    val typeNameFunction = classBody.functions.firstOrNull() ?: return null
    // `"DateTime"`
