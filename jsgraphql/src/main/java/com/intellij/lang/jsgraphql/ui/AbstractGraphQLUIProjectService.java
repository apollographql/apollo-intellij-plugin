...
abstract public class AbstractGraphQLUIProjectService implements GraphQLUIProjectService, Disposable, FileEditorManagerListener, GraphQLConfigListener {
  ...
  public AbstractGraphQLUIProjectService(final @NotNull Project project) {
    myProject = project;
  }
  ...
  public void executeGraphQL(@NotNull Editor editor, @NotNull VirtualFile virtualFile) {
    ...
    context.query = stripClientDirectives(editor, context.query);
